...
parser.add_argument('--model_type', type=str, choices=['clam_sb', 'clam_mb', 'abmil_multihead', 'abmil_multihead_sep', 'abmil'], default='clam_sb', 
...
args.temp = [float(item) for item in args.temp.split(',')]
args.n_heads = len(args.temp)	
